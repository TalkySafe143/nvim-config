...
vim.cmd("tnoremap <leader>h <C-\\><C-N><C-w>h")
vim.cmd("tnoremap <leader>j <C-\\><C-N><C-w>j")
vim.cmd("tnoremap <leader>k <C-\\><C-N><C-w>k")
vim.cmd("tnoremap <leader>l <C-\\><C-N><C-w>l")
vim.cmd("inoremap <leader>h <C-\\><C-N><C-w>h")
vim.cmd("inoremap <leader>j <C-\\><C-N><C-w>j")
vim.cmd("inoremap <leader>k <C-\\><C-N><C-w>k")
vim.cmd("inoremap <leader>l <C-\\><C-N><C-w>l")
